...
-- [[ MUGEN X LOOP INJECTION ]]
local old_input = main.f_input
function main.f_input(p, b)
    if mugenx_update then mugenx_update() end
    if mugenx_draw then mugenx_draw() end
    return old_input(p, b)
end
