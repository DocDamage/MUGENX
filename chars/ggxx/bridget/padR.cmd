;MC#5 code:"candana" ブリジット command file type R
;a:P b:K c:S x:RC:FD:DA.etc y:D z:HS
;-----AI-------------------------------------------
[Command];
name = "AL_1"
...
trigger2 = stateno != 215; && stateno != 260 
trigger2 =  movecontact && stateno % 5 = 0
trigger3 = stateno =99 || (stateno = 100 && time >= 7)
...
type = ChangeState
value = 650
triggerall = 0;command = "P"  && var(46) && var(22) > 0
...
type = ChangeState
value = 660
triggerall = 0;command = "K"  && var(46) && var(22) > 0
trigger1 = stateno = [55,56]
...
type = ChangeState
value = 670
triggerall =0; command = "S" && command != "holddown"  && var(46) && var(22) > 0
trigger1 = stateno = [55,56]
...
type = ChangeState
value = 690
triggerall =0; command = "D" && var(46) && var(22) > 0
trigger1 = stateno = [55,56]
...
trigger1 = statetype != A && ctrl
trigger2 = stateno = [200,440]
trigger2 = movecontact && stateno != 215 && stateno != 260
trigger3 = stateno =99 || (stateno = 100 && time >= 7)
