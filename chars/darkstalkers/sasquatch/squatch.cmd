...
;DARK FORCE I BIG RESISTOR
[State -1, ARMOR]
type = ChangeState
value = 6050
triggerall = var(9) != 1
triggerall = var(18) != [1,1001] 
triggerall = var(15) != [1,1001] 
...
triggerall = var(9) != 1
triggerall = power >= 1000
triggerall = command = "banana"
trigger1 = statetype != A
trigger1 = ctrl

;-----------------------------------------------

;BIG FREEZER EX VERSION
[State -1, Big Freezer EX]
type = ChangeState
value = 4020
;triggerall = var(9) != 1
triggerall = power >= 1000
triggerall = command = "freezex"
trigger1 = statetype != A
trigger1 = ctrl

;-----------------------------------------------
;BIG TORNADO KICK ES VERSION
[State -1, Big Kick ES]
type = ChangeState
value = 1090
;triggerall = var(9) != 1
triggerall = power >= 1000
triggerall = command = "footx"
trigger1 = statetype != A
trigger1 = ctrl

;SUGAR RAY STYLE BIG PUNCH ES VERSION
[State -1, Big Punch ES]
type = ChangeState
value = 1020
;triggerall = var(9) != 1
triggerall = power >= 1000
triggerall = command = "sugarx"
trigger1 = statetype != A
trigger1 = ctrl

;BIG BREATH ES VERSION
[State -1, Big Breath ES]
type = ChangeState
value = 2040
;triggerall = var(9) != 1
triggerall = power >= 1000
triggerall = command = "breathx"
trigger1 = statetype != A
trigger1 = ctrl
...
;BIG TORNADO KICK TYPE 1
[State -1, Big Kick 1]
type = ChangeState
value = 1050
;triggerall = var(9) != 1
triggerall = command = "foot1"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = stateno = 150
trigger3 = stateno = 152

;BIG TORNADO KICK TYPE 2
[State -1, Big Kick 2]
type = ChangeState
value = 1060
;triggerall = var(9) != 1
triggerall = command = "foot2"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = stateno = 150
trigger3 = stateno = 152

;BIG TORNADO KICK TYPE 3
[State -1, Big Kick 3]
type = ChangeState
value = 1070
;triggerall = var(9) != 1
triggerall = command = "foot3"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = stateno = 150
trigger3 = stateno = 152
...
;SUGAR RAY STYLE BIG PUNCH
[State -1, Big Punch]
type = ChangeState
value = 1000
;triggerall = var(9) != 1
triggerall = command = "sugar"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = stateno = 150
trigger3 = stateno = 152
...
;triggerall = var(9) != 1
trigger1 = p2statetype = L
trigger1 = command = "squash"
trigger1 = statetype != A
trigger1 = ctrl

;----------------------------------------------------------------------------------------
[State -1,ADVANCING GUARD 1]
type = ChangeState
value = 560
;triggerall = var(9) = 1
triggerall = life > 0
...
trigger1 = random <= 100;high percent
trigger1 = statetype != A
trigger1 = ctrl
...
triggerall = P2bodydist X <= 20;access only when near
...
value = 5200
triggerall = var(9) = 1;Only AI can access
triggerall = random <= 999;high percent
triggerall = Vel Y > 0
triggerall = Pos Y >= 0
trigger1 = alive
trigger1 = CanRecover
...
type = ChangeState
value = 2070
triggerall = numprojid (1022) = 0
triggerall = numhelper (1820) = 0 && numhelper(1852) = 0
triggerall = p2stateno != 1825
triggerall = P2bodydist X >= 120;access only when near
triggerall = random <= 100;high percent
triggerall = P2life != 0;don't player when opponent had die
triggerall = statetype != A;perform when not in air
triggerall = var(9) = 1;only AI can access
...
triggerall = numhelper (1820) = 0 && numhelper(1852) = 0
triggerall = p2stateno != 1825
triggerall = P2bodydist X >= 140;access only when near
triggerall = random <= 100;high percent
triggerall = P2life != 0;don't player when opponent had die
triggerall = statetype != A;perform when not in air
triggerall = var(9) = 1;only AI can access
...
value = 3020
triggerall = p2statetype != L;player not lying down
triggerall = P2bodydist X = [-5,30];access only when near
triggerall = random <=1000;high percent
triggerall = P2life != 0;don't player when opponent had die
triggerall = statetype != A;perform when not in air
triggerall = var(9) = 1;only AI can access
...
value = 2020
triggerall = p2statetype != L;player not lying down
triggerall = P2bodydist X = [-5,20];access only when near
triggerall = random <=1000;high percent
triggerall = P2life != 0;don't player when opponent had die
triggerall = statetype != A;perform when not in air
triggerall = var(9) = 1;only AI can access
...
value = 1070
triggerall = var(9) = 1
triggerall = p2stateno = [2023,2047]
triggerall = p2movetype = H
