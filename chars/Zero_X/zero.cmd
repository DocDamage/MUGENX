...
trigger1 = Var(40) = 0
trigger1 = command = "QCFx2_x" || command = "QCFx2_y"
trigger2 = Var(40) = 10
trigger2 = command = "QCFx2_z"
value = 2000
...
triggerall = Var(40) = 0
triggerall = Power >= 1000
triggerall = command = "Combo_a" || command = "Combo_b"
trigger1 = StateType != A
trigger1 = ctrl
value = 2100
...
triggerall = Var(40) = 10
triggerall = Power >= 1000
triggerall = command = "QCFx2_x" || command = "QCFx2_y"
trigger1 = StateType != A
trigger1 = ctrl
value = 3100
...
value = 800
triggerall = Var(40) < 10
triggerall = command = "x" && command = "a" || command = "y" && command = "b"
...
triggerall = Var(40) = 0
triggerall = Var(9) < 3
triggerall = command = "Summon_BF_x"
trigger1 = StateType != A
trigger1 = ctrl
value = 1600
...
triggerall = Var(40) = 0
triggerall = Var(9) < 3
triggerall = command = "Summon_BF_y"
trigger1 = StateType != A
trigger1 = ctrl
value = 1610
...
triggerall = Var(40) = 0
triggerall = Var(9) < 3
triggerall = command = "Summon_BF_a"
trigger1 = StateType != A
trigger1 = ctrl
value = 1620
...
triggerall = Var(40) = 0
triggerall = Var(9) < 3
triggerall = command = "Summon_BF_b"
trigger1 = StateType != A
trigger1 = ctrl
value = 1630
...
triggerall = Var(40) = 0
triggerall = Var(9) < 3
triggerall = command = "Summon_DU_x" || command = "Summon_DU_y" || command = "Summon_DU_a" || command = "Summon_DU_b"
trigger1 = StateType != A
trigger1 = ctrl
trigger2 = StateNo = 40
value = 1650
...
trigger1 = command = "F-HCF_x" || command = "F-HCF_y"
trigger2 = Var(40) = 10
...
;---------------------------------------------------------------------------
; Walking Light Attack
[State -1, Walking Light Attack]
type = ChangeState
value = 205
triggerall = Var(40) = 10
