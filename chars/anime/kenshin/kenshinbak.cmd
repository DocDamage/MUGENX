...
triggerall = power >= 999 ;　　　　　　　　　　　パワーが1000以上の時のみ 
;triggerall = NumExplod3200 = 0
;triggerall = NumExplod3210 = 0
;triggerall = NumExplod3501 != 0
;triggerall = NumHelper3550 = 0
...
type = ChangeState
value = 3010
triggerall = command = Dai_Hadou
triggerall = power >= 1999 ;　　　　　　　　　　　パワーが2000以上の時のみ 
trigger1 = statetype = S
trigger1 = ctrl = 1
trigger2 = statetype = S ;　　　　　　　　　　　　状態が空中のとき
