...
trigger2 = stateno != [1000,3100)
trigger2 = movecontact
trigger3 = stateno = [21,24]

;---------------------------------------------------------------------------
;Murofusi (uses one MS bar)
;ムロフシ（MSゲージレベル１）
[State -1, Murofusi]
type = ChangeState
value = 3000
...
type = ChangeState
value = 3020
triggerall = command = "R" && (PalNo != [5,6])
triggerall = power >= 1000; && var(10) < 1
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = statetype != A
trigger2 = hitdefattr = SC, NA, SA, HA
trigger2 = stateno != [1000,3300)
trigger2 = movecontact
trigger3 = stateno = [21,24]
...
type = ChangeState
value = 3100
triggerall = command = "B" && (PalNo != [5,6])
triggerall = power >= 1000
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = statetype != A
...
;---------------------------------------------------------------------------
;Clock Up (uses one super bar)
[State -1, Smash Kung Fu Upper]
type = ChangeState
value = 730
triggerall = command = "ClockUp" && (PalNo != [5,6])
;triggerall = power >= 1000
triggerall = statetype != A
trigger1 = ctrl
...
trigger1 = ctrl
trigger2 = (stateno = [200,299]) || (stateno = [400,430])
...
;type = ChangeState
;value = 1120
;triggerall = command = "QCF_c" && (PalNo != [5,6])
...
type = ChangeState
value = 1100
triggerall = command = "upper_x" && var(9) = 0 && stateno != [1100,1115]
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]
...
type = ChangeState
value = 1105
triggerall = command = "upper_y" && var(9) = 0 && stateno != [1100,1115]
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]
...
[State -1, Light RT]
type = ChangeState
value = 1110+5*(var(8) = [1,367]) && (PalNo != [5,6])
triggerall = command = "upper_x" && var(9) = 0 && stateno != [1100,1115]
...
type = ChangeState
value = 1110+5*(var(8) = [1,367]) && (PalNo != [5,6])
triggerall = command = "upper_y" && var(9) = 0
trigger1 = statetype = A && ctrl
trigger2 = stateno = [770,780]
...
type = ChangeState
value = 1400
triggerall = (command = "GH_x" || command = "GH_y") && (PalNo != [5,6])
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]
...
;type = ChangeState
;value = 1040
;triggerall = command = "QCB_c" && (PalNo != [5,6])
;triggerall = power >= 330
;trigger1 = var(1) ;Use combo condition (above)
;trigger2 = stateno = [21,24]
...
triggerall = command = "QCF_x" && (stateno != [1100,1115]) && (PalNo != [5,6])
trigger1 = statetype = A && ctrl
trigger2 = stateno = [770,780]
trigger3 = (stateno = [600,645]) && movecontact
trigger4 = (stateno = [700,720]) && statetype = A
...
triggerall = command = "QCF_y" && (PalNo != [5,6]) && (PalNo != [5,6])
trigger1 = statetype = A && ctrl
trigger2 = stateno = [770,780]
trigger3 = (stateno = [605,615]) || (stateno = [635,645])
trigger3 = stateno != 610 && stateno != 640 && movecontact
...
type = ChangeState
value = 1450
triggerall = (command = "V_x" || command = "V_y") && (PalNo != [5,6])
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]
...
type = ChangeState
value = 760
triggerall = command = "QCF_z" && numexplod(93) = 0 && numhelper(17) = 0
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]
...
type = ChangeState
value = 1600
triggerall = (stateno = [150,153]) && (PalNo != [5,6])
...
type = ChangeState
value = 1220
triggerall = command = "QCB_xy" && (PalNo != [5,6])
triggerall = power >= 330
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]
...
type = ChangeState
value = 1200
triggerall = command = "QCB_x" && (PalNo != [5,6])
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]
...
type = ChangeState
value = 1210
triggerall = command = "QCB_y" && (PalNo != [5,6])
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]
...
type = ChangeState
value = 1230
triggerall = command = "QCB_a" && (PalNo != [5,6])
trigger1 = var(1) ;Use combo condition (above)
trigger2 = stateno = [21,24]

;---------------------------------------------------------------------------
;じゃべりん
[State -1, Gungul Javelin]
type = ChangeState
value = 1250+5*(var(8) = [1,367])
triggerall = (command = "QCB_x" || command = "QCB_y") && (PalNo != [5,6])
trigger1 = statetype = A && ctrl
trigger2 = stateno = [770,780]
trigger3 = (stateno = [600,645]) && movecontact
trigger4 = (stateno = [700,720]) && statetype = A
