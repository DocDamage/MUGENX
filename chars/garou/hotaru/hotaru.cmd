...
;-| Direction + 2/3 Button Combination |-----------------------------------
[Command]
name = "down_xy"
command = /$D,x+y
time = 1
...
trigger10 = numexplod(9990) = 1
trigger11 = numexplod(9991) = 1
trigger11 = statetype = S
;---------------------------------------------------------------------------
; Ten Shou Shin B
[State -1]
type = ChangeState
...
triggerall = ctrl = 1
trigger1 = command = "HCF_b";p2 stand
trigger1 = stateno != 100    ;Not running
trigger1 = command != "holdback" 
trigger1 = p2statetype = S
trigger1 = p2movetype != H
trigger2 = command = "HCF_b";p2 crouch
trigger2 = stateno != 100    ;Not running
trigger2 = p2statetype = C
trigger2 = p2movetype != H
trigger3 = command = "HCF_b";p2 stand
trigger3 = p2statetype = S
trigger3 = p2movetype != H
trigger4 = command = "HCF_b";p2 crouch
...
triggerall = statetype = S
triggerall = ctrl = 1
triggerall = p2bodydist X < 7 ;Near P2
...
trigger2 = numexplod(9990) = 1
trigger3 = numexplod(9991) = 1
