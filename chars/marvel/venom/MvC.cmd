...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = (stateno = 200) && MoveContact && Var(55)
trigger3 = (stateno = 230) && MoveContact && Var(55)
trigger4 = (stateno = 400) && MoveContact && Var(55)
trigger5 = (stateno = 430) && MoveContact && Var(55)
...
trigger3 = ((stateno = [200,220]) || (stateno = [400,420])) && MoveContact && !Var(55) 
...
trigger8 = ((stateno = [200,220]) || (stateno = [400,420])) && MoveContact && !Var(55) 
;---------------------------------------------------------------------------
;Stand Strong Punch
[State -1]
type = ChangeState
...
trigger1 = statetype = S
trigger1 = ctrl
trigger2 = (stateno = [200,240]) && MoveContact && Var(55)
trigger3 = (stateno = [400,440]) && MoveContact && Var(55)
trigger4 = ((stateno = [200,220]) || (stateno = [400,420])) && MoveContact && !Var(55) 
...
trigger3 = (stateno = 630) && MoveContact && (Var(55) || Var(4))
...
trigger4 = (stateno = 630) && MoveContact && (Var(55) || Var(4))
...
trigger1 = ctrl
trigger2 = (stateno = 600) && MoveContact && (Var(55) || Var(4))
trigger3 = (stateno = [600,620]) && !Var(55)
...
trigger6 = (stateno = [600,620]) && MoveContact && !Var(55) 
;---------------------------------------------------------------------------
...
trigger5 = (stateno = 640) && MoveContact && (Var(55) || Var(4))
trigger6 = stateno = 102 && Animelemtime(2) >=0
trigger7 = (stateno = [600,620]) && MoveContact && !Var(55) 
