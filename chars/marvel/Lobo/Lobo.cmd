...
triggerall = MoveType != H
triggerall = ctrl = 1
trigger1 = (command = "frag1") ;&& (var(5) > 0)
;trigger2 = (command = "frag2") && (var(5) = 1)
;trigger3 = (command = "frag3") && (var(5) = 1)
...
triggerall = MoveType != H
triggerall = ctrl = 1
trigger1 = (command = "frag2") ;&& (var(5) > 1)
;trigger2 = (command = "frag3") && (var(5) = 2)
...
triggerall = MoveType != H
triggerall = ctrl = 1
trigger1 = (command = "frag3") ;&& (var(5) > 2)
...
trigger3 = (command = "holdup") && (StateNo = 455) && (MoveHit = 1) 
trigger4 = (command = "holdup") && (PrevStateNo = 455) && (MoveHit = 1) 
