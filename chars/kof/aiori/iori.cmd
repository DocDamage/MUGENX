...
trigger6 = stateno = 2100 && Animelemtime(5) > 1 && Animelemtime(6) <= 1 && movehit = 0
trigger7 = stateno = 2200 && Animelemtime(5) > 1 && Animelemtime(6) <= 1 && movehit = 0
...
type = ChangeState
value = 2600
triggerall = var(9) = 1 && random <= 500 &&  p2statetype = C
