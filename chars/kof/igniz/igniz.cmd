...
trigger6 = animelem = 14, <= 0
trigger7 = var(58) = 1
trigger7 = movecontact
trigger7 = stateno = 1030 || stateno = 1031
...
type = ChangeState
value = 200
triggerall = command = "x" || command = "holddown" && command = "x"
trigger1 = statetype != A
trigger1 = ctrl
