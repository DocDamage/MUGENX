...
[State -2]
type = varset
trigger1 = command = "1100_b"
var(25) = 1156
ignorehitpause = 1

[State -2]
type = varset
trigger1 = command = "1100_a"
var(25) = 1106
ignorehitpause = 1

[State -2]
type = varset
trigger1 = command = "1000_y"
var(25) = 1056
ignorehitpause = 1

[State -2]
type = varset
trigger1 = command = "1000_x"
var(25) = 1006
ignorehitpause = 1

[State -2]
type = varset
trigger1 = command = "1200_b"
var(25) = 1256
ignorehitpause = 1

[State -2]
type = varset
trigger1 = command = "1200_a"
var(25) = 1206
ignorehitpause = 1

[State -2]
type = varset
trigger1 = command = "1300_y"
var(25) = 1356
ignorehitpause = 1

[State -2]
type = varset
trigger1 = command = "1300_x"
var(25) = 1306
ignorehitpause = 1
...
type = ChangeState
value = 1400
triggerall = (P2dist X > 0 && ((var(25) = [1100,1105]) || (var(25) = [3000,3005]))) || (P2dist X < 0 && (var(25) = [1200,1205]))
triggerall = statetype = A && var(55) = 0
...
type = ChangeState
value = 1450
triggerall = (P2dist X > 0 && ((var(25) = [1150,1155]) || (var(25) = [3050,3055]))) || (P2dist X < 0 && (var(25) = [1250,1255]))
triggerall = statetype = A && var(55) = 0
trigger1 = (ctrl && statetype = A) || (stateno = 105 && time > 3)
trigger2 = var(24) > 0 && (stateno = 610 || stateno = 615 || stateno = 640 || stateno = 641 || stateno = 761)
trigger3 = var(24) > 0 && (stateno = 645 || stateno = 650)
...
type = ChangeState
value = 1220
triggerall = (P2dist X > 0 && (var(25) = [1200,1205])) || (P2dist X < 0 && ((var(25) = [1100,1105]) || (var(25) = [3000,3005])))
triggerall = statetype = A && var(55) = 0
trigger1 = (ctrl && statetype = A) || (stateno = 105 && time > 3)
trigger2 = var(24) > 0 && (stateno = 610 || stateno = 615 || stateno = 640 || stateno = 641 || stateno = 761)
trigger3 = var(24) > 0 && (stateno = 645 || stateno = 650)
...
type = ChangeState
value = 1270
triggerall = (P2dist X > 0 && (var(25) = [1250,1255])) || (P2dist X < 0 && ((var(25) = [1150,1155]) || (var(25) = [3050,3055])))
triggerall = statetype = A && var(55) = 0
trigger1 = (ctrl && statetype = A) || (stateno = 105 && time > 3)
trigger2 = var(24) > 0 && (stateno = 610 || stateno = 615 || stateno = 640 || stateno = 641 || stateno = 761)
trigger3 = var(24) > 0 && (stateno = 645 || stateno = 650)
...
type = ChangeState
value = 700
triggerall = (var(26) = [200,205]) && command = "holdfwd"
...
type = ChangeState
value = 260
triggerall = (var(26) = [250,255]) || command = "holddown" && (var(26) = [900,905]) || (var(26) = [1990,1995])
