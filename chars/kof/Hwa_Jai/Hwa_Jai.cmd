...
trigger1 = stateno = [670,671]
trigger2 = stateno = 653
trigger3 = stateno = [6531,6533]
trigger4 = stateno = [6771,6772]
trigger5 = stateno = [6781,6782]
trigger6 = stateno = [677,678]
...
triggerall = statetype != A
trigger1 = ctrl = 1
trigger2 = (stateno = [200,210]) && (stateno != 203) && (stateno != 306)
...
;trigger1 = (stateno = [200,210]) && (stateno != 203) && (stateno != 306)
;trigger2 = (stateno = [305,308]) && (stateno != 203) && (stateno != 306)
...
triggerall = command = "y"
triggerall = command = "a"
trigger1 = stateno = [615,616]
trigger2 = stateno = [6151,6162]
trigger3 = stateno = 653
helpertype = normal
name = "H"
id = 887
pos = -40,0
...
;type = ChangeState
;value = 77772
;triggerall = stateno != 77772
;triggerall = NumHelper(77771) != 1
;triggerall = command = "y1"
...
trigger1 = statetype != A
trigger1 = (stateno = [200,210]) && (stateno != 203) && (stateno != 209)
