...
value = 9100
triggerall = var(9) = 1
triggerall = p2stateno != 131 && p2stateno != 130 && P2bodydist X <= 15 && random <= 1000 && P2stateno != 5201
...
value = 9020
triggerall = var(9) = 1
trigger1 = p2stateno != 131 && p2stateno != 130 && P2bodydist X <= 15 && random <= 1000 && P2stateno != 5201
...
triggerall = (var(41) = [0,3]) || var(41) = 5 || (var(41) = [6,7])
triggerall = var(21) = 0 || var(21) = 2
triggerall = p2statetype != L && P2stateno != 5201
...
trigger1 = p2bodydist Y > -138 && p2bodydist Y < -135
...
trigger1 = p2statetype != L && p2statetype != A && statetype = S && ctrl && P2stateno != 5201 && P2stateno != [700,800]
...
triggerall = var(9) = 1
triggerall = var(41) != 4
triggerall = (p2bodydist x = [0,30]) && p2statetype != A && P2stateno != 5201
...
triggerall = var(9) = 1
triggerall = var(41) = 0 || var(41) = 2 || var(41) = 5 || (var(41) = 7)
triggerall = ctrl && p2statetype != L && p2statetype != A && random <= 500
trigger1 = p2bodydist x <= 50 && statetype !=  A && (p2stateno = [200,500]) && p2movetype = A

[State -1, Oniyaki]
type = ChangeState
value = ifelse(random <= 700,1600,1650)
triggerall = var(9) = 1 && random <= 700 && var(41) != 3 && p2movetype != H && statetype != A
trigger1 = ctrl && p2movetype = A && p2bodydist x <= 50 && p2statetype = A && p2bodydist y >= -70 && p2stateno != 5040 && (enemy, facing) != facing
...
trigger1 = statetype != A && random <= 900 && (p2bodydist x = [0,18]) && stateno = 250 && movehit && animelemtime(2) > 0 && animelemtime(3) < 0
trigger2 = HitShakeOver
trigger2 = (var(21) = 1 || var(41) = 1) && (stateno = 150 || stateno = 152)  
...
triggerall = (P2bodydist X = [0,40]) && p2statetype = L && p2stateno = 5101
...
trigger1 = life > 200 && power >= 1000 && var(10) <= 0 && p2statetype != L && p2statetype != A && P2stateno != 5201
trigger1 = (p2bodydist x = [5,50]) && p2movetype = A && random >= 600 && statetype != A && ctrl
trigger2 = var(40) > 0 && P2stateno != 5201
trigger2 = var(39) = 1 || var(42) = 1
...
trigger1 = (p2bodydist x = [10,60]) && power >= 1000 && var(10) <= 0 && P2stateno != 5201
...
triggerall = var(41) = 0 || var(41) = 2 || var(41) = 4
triggerall = var(21) = 0 || var(21) = 2
triggerall = p2statetype != L && p2statetype != A && P2stateno != 5201
trigger1 = life > 200 && power >= 1000 && var(10) <= 0
trigger1 = (p2bodydist x = [30,60]) && random >= 500 && statetype != A && ctrl
...
trigger3 = random <= 700 && p2movetype != A && p2stateno = 5120 
trigger4 = random <= 700 && p2movetype != A && p2stateno = 5201 
...
trigger1 = p2bodydist x > 40 &&  p2movetype != A && random < 300 && p2statetype != A
