...
; (There's currently just enough room for all three disabled commands to be
;  re-enabled, but until they're used, they may as well stay disabled.
;  If more space is ever needed, then simply remove some commands from
;  the XOR-ed commands AI activation method.)
...
;============================
;SPECIAL COMMAND CANCELS VAR
;============================

[State -1, C.Combo1]
type = Varset
triggerall = var(40) > 0 || var(21) = 2 || (var(21) = [5,6])
trigger1 = 1
var(42) = 0
...
trigger10 = stateno = 4565 && animelemtime(12) > 0 && animelemtime(13) < 0
...
trigger15 = stateno = 2001 && animelemtime(5) > 0
trigger16 = stateno = 2105 && animelemtime(4) > 0
ignorehitpause = 1
var(42) = var(42) | 1

[State -1, C.Combo3]
type = Varset
triggerall = var(40) > 0 || (var(21) = [5,6]) || var(21) = 2
...
[State -1, Basics1]
type = Varset
triggerall =  var(10) > 0 &&  (var(21) = 2 || var(21) = 6) 
trigger1 = 1
var(48) = 0

[State -1, Basics2]
type = Varset
triggerall = var(10) > 0 && (var(21) = 6 || var(21) = 2)
trigger1 = stateno = 220 && animelemtime(2) > 0 && (var(21) = 6 || var(21) = 2)
trigger2 = stateno = 260 && animelemtime(5) > 0 && (var(21) = 6 || var(21) = 2)
trigger3 = stateno = 265 && animelemtime(7) > 0 && (var(21) = 6 || var(21) = 2)
trigger4 = stateno = 447 && animelemtime(2) > 0 && (var(21) = 6 || var(21) = 2)
trigger5 = stateno = 470 && animelemtime(2) > 0 && (var(21) = 6 || var(21) = 2)
ignorehitpause = 1
var(48) = var(48) | 1
...
;Kamijiri
[State -1, Kamijiri SDM 2K2Mix ]
type = ChangeState
value = 9100
ctrl = 0
;triggerall = var(9) != 1
triggerall = (var(41) = 6 && command = "kamisz") || (var(41) = 2 && command = "kamissz")
triggerall = (var(21) = 2 || var(21) = 6) 
triggerall = power >= 1000 && var(10) > 0
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && power >= 2000 && var(10) > 0
...
;Kamijiri
[State -1, Kamijiri 2k2mix]
type = ChangeState
value = 9020
ctrl = 0
;triggerall = var(9) != 1
triggerall = (var(41) = 6 && command = "kamisx") || (var(41) = 2 && command = "kamissx")
triggerall = var(21) = 6 || var(21) = 2
triggerall = power >= 1000 || var(10) > 0
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && (power >= 2000 || var(10) > 0 && power >= 1000)
...
;2K Shiki
[State -1, 2K Shiki 2k2mix]
type = ChangeState
value = 4900
ctrl = 0
;triggerall = var(9) != 1
triggerall = (var(41) = 5 && command = "mushiki") || (var(41) = 2 && command = "shiki2k")
triggerall = var(21) = 6 || var(21) = 2
triggerall = power >= 1000 || var(10) > 0
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
...
;Ura Hyaku Hachi Shiki: Orochi Nagi SDM
[State -1, OrochiNagiSDM '2K2]
type = ChangeState
value = 3050
ctrl = 0
;triggerall = var(9) != 1
triggerall = command = "orochinagix" && var(41) != 4
triggerall = (var(21) = 2 || var(21) = 6) 
triggerall = power >= 1000 && var(10) > 0
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
...
;Ura Hyaku Hachi Shiki: Orochi Nagi II
[State -1, OrochiNagiMIX2k2]
type = ChangeState
value = 3000
ctrl = 0
;triggerall = var(9) != 1
triggerall = command = "orochinagi1" && var(41) != 4
triggerall = var(21) = 6 || var(21) = 2
triggerall = power >= 1000 || var(10) > 0
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
...
ctrl = 0
;triggerall = var(9) != 1
triggerall = command = "orochinagi2" && var(41) != 4
triggerall = var(21) = 6 || var(21) = 2
triggerall = power >= 1000 || var(10) > 0
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 1802
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != [1600,1655]
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 1821
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 1901
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != [1700,1710]
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 2001
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 2105
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) 
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 4500
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 4565
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 4580
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
trigger1 = statetype != A && ctrl
trigger2 = var(39) = 1
trigger3 = var(42) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2) && stateno != 4585
trigger4 = var(48) = 1 && var(10) > 0 && (var(21) = 6 || var(21) = 2)
...
value = 707
;triggerall = var(9) != 1
triggerall = (command = "holdx" && command = "holdy" && command = "holda") || (command ="holdy" && command ="holdz")
triggerall = var(21) = 0 || var(21) = 2 || var(21) = 6
...
triggerall = (command = "holdx" && command = "holdy" && command = "holda") || (command ="holdy" && command ="holdz")
triggerall =  var(21) = 2 || var(21) = 6
triggerall = var(10) <= 0 && var(40) <= 0 && var(37) <= 0 && power >= 2000
trigger1 = var(39) = 1 && stateno != 100
...
trigger1 = var(21) = 0 || var(21) = 4 || (var(21) = [5,6]) 
trigger1 = (ctrl || stateno = 100)
...
trigger1 = stateno != 3900 && (stateno != [707,708]) && stateno != 4850 && movetype != H && stateno != 0
ignorehitpause = 1
helpertype = normal
id      = 4000
stateno = 4000
...
trigger1 = roundstate = 2 && numhelper(4000) <= 0 && stateno != 7700
trigger1 = (stateno != [3000,3690]) && (stateno != [4600,4800]) && (stateno != [300,315]) && (stateno != [4900,4999]) && (stateno != [9020,9150])
trigger1 = stateno != 3900 && (stateno != [707,708]) && stateno != 4850 && movetype != H && stateno != 0
ignorehitpause = 1
helpertype = normal
...
trigger1 = numhelper(7110) <= 0 && (stateno != [4800,4850]) && (stateno != [707,708]) && movetype != H 
ignorehitpause = 1
helpertype = normal
id      = 7110
stateno = 7110
...
triggerall = (var(41) = [0,2]) || var(41) = 4 || var(41) = 5 || var(41) = 6 || (var(41) = [7,8])
trigger1 = statetype = A && ctrl
...
triggerall = (var(41) = [0,2]) || (var(41) = [5,8])
trigger1 = statetype != A && ctrl
...
triggerall = var(21) = 0 || (var(21) = [2,6])
trigger1 = statetype = S && ctrl
