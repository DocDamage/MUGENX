...
triggerall = var(6) = 0
triggerall = var(30) = 0
triggerall = command = "mugen" || command = "mugen2" || command = "mugen3" || command = "mugen3B"
triggerall = statetype != A
trigger1 = ctrl
;—§‚¿Œn
trigger2 = (stateno = [200,230]) || stateno = 250
...
triggerall = var(6) = 0
triggerall = var(30) = 0
triggerall = command = "boku" || command = "bokuB"
triggerall = statetype != A
trigger1 = ctrl
;—§‚¿Œn
trigger2 = (stateno = [200,230]) || stateno = 250
...
value = 1102
triggerall = roundstate = 2
triggerall = command = "food_3" || command = "food_3B"
triggerall = NumHelper(1100)= 0
triggerall = statetype != A
trigger1 = ctrl
;—§‚¿Œn
...
triggerall = command = "x+a" || command = "c"
...
triggerall = statetype = S
triggerall = ctrl
trigger1 = command = "x+a" || command = "c"
trigger2 = command = "x"
trigger3 = command = "a"
;-------------------------------------------
;‚µ‚á‚ª‚İ
