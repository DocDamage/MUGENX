...
;Seek a State Time >= 120
[State -1]
type = VarSet
trigger1 = Time >= 0
ignorehitpause = 1
fvar(7+GameTime%2) = P2StateNo

[State -1]
type = VarAdd
trigger1 = P2MoveType = A
trigger1 = P2StateNo >= 200
trigger1 = (MoveType != A)||(StateNo = [5000,5999])
...
trigger1 = FVar(9) <= 10
trigger1 = P2MoveType = A
trigger1 = (Random = [0,100])||(P2StateNo >= 3000)
trigger2 = FVar(10) != 0
trigger2 = P2StateNo = FVar(10)
trigger2 = FVar(9) <= 10
ignorehitpause = 1
value = 3100
...
type = VarSet
triggerall = MoveType = H
trigger1 = Helper(1000), PrevStateNo = 1001
trigger2 = Helper(1000), PrevStateNo = 1002
trigger3 = Helper(1000), PrevStateNo = 1003
trigger4 = Helper(1000), StateNo = 1001
trigger5 = Helper(1000), StateNo = 1002
trigger6 = Helper(1000), StateNo = 1003
trigger7 = PrevStateNo = 1000
trigger8 = PrevStateNo = 1010
trigger9 = PrevStateNo = 1020
ignorehitpause = 1
fvar(3) = 1.0
...
type = VarSet
triggerall = MoveType = H
trigger1 = Helper(1000), PrevStateNo = 1102
trigger2 = Helper(1000), PrevStateNo = 1121
trigger3 = Helper(1000), StateNo = 1102
trigger4 = Helper(1000), StateNo = 1121
ignorehitpause = 1
fvar(1) = 1.0
...
[State -1]
type = VarAdd
trigger1 = Helper(1000), StateNo = 1102
trigger1 = Helper(1000), AnimElem = 2,>0
trigger1 = Helper(1000), MoveContact = 0
ignorehitpause = 1
fvar(12) = 300
...
trigger4 = RoundState = 2
trigger4 = Var(59)
trigger4 = (FVar(3) = 0)||(Helper(1000), MoveHit)
trigger4 = Random <= Var(17)
...
trigger4 = Var(59)
trigger4 = FVar(3) = 1
trigger4 = (Helper(1000), StateNo = 1101)||(Helper(1000), StateNo = 1111)||(Helper(1000), StateNo = 1121)
...
triggerall = ((P2MoveType != A)||(PrevStateNo=[120,159]))
...
type = ChangeState
triggerall = Var(5) = 1
triggerall = ((Command = "FDFx")||(Command = "FDFy")||(Command = "FDFz"))||Var(59)
triggerall = ((Var(59)=0)||((P2BodyDist X>=150)&&(FVar(11)=0)))
trigger1 = StateType != A
trigger1 = Ctrl
trigger2 = StateNo = 70200
trigger3 = StateNo = 70210
...
type = VarSet
triggerall = MoveType = H
trigger1 = PrevStateNo = [71100,71101]
ignorehitpause = 1
fvar(0) = 1.0
...
triggerall = RoundState = 2
trigger1 = (FVar(0) = 0)||(PrevStateNo = [151,153])
trigger1 = StateType != A
trigger1 = Ctrl
trigger1 = (P2MoveType != A)||(PrevStateNo = [120,159])
trigger1 = P2StateType != A
...
triggerall = Random <= Var(17)
triggerall = RoundState = 2
triggerall = (MoveHit||((Random<=99)&&(FVar(0) = 0)))
trigger1 = StateNo = 70210
trigger1 = MoveHit
trigger2 = StateNo = 70220
trigger2 = PrevStateNo != 70200
...
triggerall = (MoveHit||((Random<=20)||((P2StateType=S)&&(Random<=99))&&(FVar(2)=0)))
...
trigger1 = ((P2MoveType != A)||(PrevStateNo=[120,159])||(PrevStateNo=[1200,1220]))
trigger1 = P2StateType != A
...
trigger2 = PrevStateNo != 100
trigger2 = AnimElem = 3,>0
trigger2 = (MoveHit)||(P2StateType=C)
value = 70200
ctrl = 0
...
trigger2 = PrevStateNo != 100
trigger2 = AnimElem = 3,>0
trigger2 = (P2StateType = C)||(Random<=300)
value = 70210
ctrl = 0
...
type = ChangeState
triggerall = Var(5) = 1
triggerall = StateNo = 70210
triggerall = PrevStateNo != 100
triggerall = PrevStateNo = 70200
triggerall = Var(14) = 70200
...
triggerall = Anim != 5
trigger1 = Var(5) = 0
trigger1 = (P2BodyDist X < 90)||( P2BodyDist X > 120)
trigger2 = Var(5) = 1
