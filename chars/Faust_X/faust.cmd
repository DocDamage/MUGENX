...
triggerall = var(25) = 0
triggerall = power >= 1000
triggerall = command = "な・な・な・なにがでるかな！"
...
triggerall = var(58) = 1
triggerall = var(25) = 0
triggerall = command = "ごーいんぐまいうぇい"
trigger1 = statetype = A
trigger1 = ctrl
trigger2 = (stateno = [600,650]) && movecontact
trigger3 = stateno = 110 || stateno = 115
;trigger3 = time >= 9
trigger4 = stateno = 99; && prevstateno = 610
...
trigger6 = time > ifelse(anim = 197,20,61)
;===========================================================================
[State 特殊ガード];爆弾出たときのガード
type = ChangeState
value = 120;130+(statetype = C)+(statetype = A)*2
triggerall = command = "holdback"
triggerall = ctrl
trigger1 = numhelper(1334) && var(30)
trigger2 = numhelper(1412) && var(31)
;---------------------------------------------------------------------------
[State -1, Run Fwd]
type = ChangeState
value = 100
...
trigger5 = (stateno = [230, 234])
trigger5 = movecontact
trigger6 = stateno = 400
trigger6 = movecontact
trigger7 = (stateno = [410, 415]) 
trigger7 = movecontact
trigger8 = stateno = 420
trigger8 = movecontact
trigger9 = stateno = 431
trigger9 = movecontact
trigger10 = stateno = [100, 101]
trigger11 = stateno = [195, 197]
trigger11 = time > ifelse(anim = 197,20,61)
;---------------------------------------------------------------------------
[State -1]
type = ChangeState
value = 240
...
trigger4 = stateno = 220
trigger4 = movecontact
trigger5 = (stateno = [224, 225])
trigger5 = movecontact
trigger6 = (stateno = [230, 234])
trigger6 = movecontact
...
trigger2 = movecontact
trigger3 = (stateno = [220, 225])
trigger3 = movecontact
trigger4 = (stateno = [410, 415])
trigger4 = movecontact
...
trigger4 = (stateno = [410, 415]) && movecontact 
