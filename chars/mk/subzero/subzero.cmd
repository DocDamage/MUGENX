...
triggerall = p2statetype != A
triggerall = p2life > 2
trigger1 = p2bodydist X > 20 && p2bodydist X < 190
trigger2 = stateno = 10000
trigger2 = movecontact = 1
trigger3 = stateno = 3000
trigger3 = movecontact = 1
trigger4 = p2stateno = 2002
trigger5 = p2stateno = 5300
trigger6 = p2stateno != 9010


[State -1, AI Shadow Air Kick - Far]
type = ChangeState
value = 7447
triggerall = Var(50) = 1
triggerall = random >= 290 && random < 299 || random >= 990 && random <= 999
...
triggerall = p2life > 2
triggerall = statetype != A
trigger1 = p2bodydist X > 2 && p2bodydist X < 15
trigger1 = stateno = 7447
trigger1 = movehit = 1
trigger2 = stateno = 2020
trigger2 = movehit = 1
trigger2 = p2bodydist X > 2 && p2bodydist X < 15
trigger3 = p2bodydist X > 2 && p2bodydist X < 15
trigger4 = prevstateno = 7447
trigger4 = p2bodydist X > 2 && p2bodydist X < 15
...
triggerall = p2stateno = 9010
triggerall = p2life < 10
trigger1 = p2bodydist X > 91 && p2bodydist X < 129
...
triggerall = p2stateno = 9010
triggerall = p2life < 10
trigger1 = p2bodydist X > 180 && p2bodydist X < 200
...
trigger1 = ctrl = 1
trigger1 = statetype = S
trigger1 = p2bodydist X > 150 && p2bodydist X < 250
...
triggerall = p2stateno = 9010
triggerall = p2life < 10
trigger1 = p2bodydist X > 150 && p2bodydist X < 179
...
trigger1 = ctrl = 1
trigger1 = statetype = S
trigger1 = p2bodydist X > 140 && p2bodydist X < 160

[State -1, AI Ice Breath]
type = ChangeState
value = 5510
triggerall = Var(50) = 1
triggerall = random >= 250 && random < 299 || random >= 950 && random <= 999
...
triggerall = p2stateno = 9010
triggerall = p2life < 10
trigger1 = p2bodydist X > 130 && p2bodydist X < 149
...
trigger1 = p2bodydist X > 81 && p2bodydist X < 90
...
trigger1 = ctrl = 1
trigger1 = statetype = S
trigger1 = p2bodydist X >= 1 && p2bodydist X < 200
...
value = 8100
triggerall = Var(50) = 1
triggerall = random >= 220 && random < 299 || random >= 250 && random <= 999
triggerall = statetype = S
triggerall = ctrl = 1
triggerall = p2stateno = 9010
triggerall = p2life < 1
trigger1 = p2bodydist X > 120 && p2bodydist X < 129
...
trigger1 = ctrl = 1
trigger1 = statetype = S
trigger1 = p2bodydist X > 1 && p2bodydist X < 100
...
value = 9400
triggerall = Var(50) = 1
triggerall = random >= 250 && random < 299 || random >= 650 && random <= 999
triggerall = statetype = S
triggerall = ctrl = 1
triggerall = p2stateno = 9010
triggerall = p2life < 10
triggerall = P2statetype = S
trigger1 = p2bodydist X > 1 && p2bodydist X < 30
...
trigger1 = ctrl = 1
trigger1 = statetype = S
trigger1 = p2bodydist X > 89 && p2bodydist X < 149
...
triggerall = p2life < 10
triggerall = P2statetype = S
trigger1 = p2bodydist X > 90 && p2bodydist X < 149
...
triggerall = p2life < 10
triggerall = P2statetype = S
trigger1 = p2bodydist X > 51 && p2bodydist X < 90
;--------------------------------------------------------------------

[State -1, Super Cicle Throw]
type = Changestate
value = 80000
triggerall = command = "supercicle"
triggerall = power >= 2000
trigger1 = ctrl = 1
trigger1 = statetype = S

[State -1, AI Super Icicle Throw]
type = ChangeState
value = 80000
triggerall = Var(50) = 1
...
trigger1 = p2bodydist X > 130 && p2bodydist X < 270
trigger2 = stateno = 2020 ;Floor Ice
trigger2 = movecontact = 1
trigger3 = p2stateno = 1005
trigger4 = p2stateno = 1523
trigger5 = p2stateno = 1522
trigger6 = p2stateno = 1521
...
triggerall = power >= 2000
triggerall = p2life >= 10
trigger1 = p2bodydist X > 90 && p2bodydist X < 110


[State -1, Ice Orb]
type = Changestate
value = 20001
triggerAll = command = "iceorb"
triggerAll = power >= 2000
trigger1 = ctrl = 1
trigger1 = statetype = S
...
trigger1 = p2bodydist X > 80 && p2bodydist X < 120
...
triggerall = p2life > 5
trigger1 = p2stateno = 1521
trigger2 = p2stateno = 1005
...
value = 245
triggerall = Var(50) = 1
triggerall = random >= 200 && random < 299 || random >= 200 && random <= 999
triggerall = ctrl = 1
triggerall = statetype = S
triggerall = p2statetype != A
triggerall = p2life > 10
...
value = 3000
triggerall = Var(50) = 1
triggerall = random >= 100 && random < 299 || random >= 680 && random <= 999
triggerall = statetype = S
triggerall = ctrl = 1
triggerall = p2life >= 10
trigger1 = p2bodydist X = 50
...
trigger7 = p2name = "scorpion"
trigger7 = p2stateno = 3101

[State -1, AI Frozen Slide]
type = ChangeState
value = 3000
triggerall = Var(50) = 1
triggerall = random >= 200 && random < 299 || random >= 950 && random <= 999
...
triggerall = ctrl = 1
triggerall = p2statetype != A
triggerall = p2bodydist X > 50 && p2bodydist X < 300
trigger1 = p2stateno = 1521
trigger2 = p2stateno = 1005

[State -1, AI Frozen Slide2]
type = ChangeState
value = 3000
triggerall = Var(50) = 1
triggerall = random >= 100 && random < 299 || random >= 750 && random <= 999
...
triggerall = p2statetype != A
triggerall = ctrl = 1
triggerall = p2bodydist X > 1 && p2bodydist X < 350
trigger1 = p2stateno = 1521
trigger2 = p2stateno = 1522
trigger3 = p2stateno = 1522
trigger4 = p2stateno = 1005

[State -1, Super Ice Shower]
type = Changestate
value = 20000
triggerall = command = "supericeshower"
triggerall = power >= 2000
trigger1 = ctrl = 1
trigger1 = statetype = S
...
triggerall = p2stateno != 1522
triggerall = p2stateno != 1522
triggerall = p2stateno != 1005
trigger1 = p2bodydist X = 80
trigger2 = p2bodydist X = 290
trigger3 = p2name = "scorpion"
trigger3 = p2stateno = 31101 

[State -1, AI Walk And Uppercut]
type = ChangeState
value = 666
triggerall = Var(50) = 1
triggerall = ctrl = 1
triggerall = random >= 100 && random < 299 || random >= 800 && random <= 999
triggerall = statetype = S
trigger1 = p2stateno = 1521
trigger2 = p2stateno = 1005
trigger3 = p2stateno = 1522
trigger4 = p2stateno = 1522
triggerall = p2bodydist X > 1 && p2bodydist X < 300

;===========================================================================
[State -1, IceThrow]
type = Changestate
value = 1200
triggerall = command = "IceThrow"
trigger1 = ctrl = 1
trigger1 = statetype = S

[State -1, AI Ice Throw]
type = ChangeState
value = 1200
triggerall = Var(50) = 1
triggerall = ctrl = 1
...
trigger4 = p2bodydist X = 275
trigger5 = stateno = 80000 ;Cicle
trigger5 = movecontact = 1

[State -1, Ice In Air]
type = Changestate
value = 1100
triggerall = command = "iceinair"
trigger1 = ctrl = 1
trigger1 = statetype = A

[State -1, AI Ice In Air]
type = ChangeState
value = 1100
triggerall = Var(50) = 1
triggerall = ctrl = 1
...
triggerall = Vel X != 0 
triggerall = p2life > 5
trigger1 = p2bodydist X > 10 && p2bodydist X < 300
